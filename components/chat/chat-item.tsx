...
type ChatItemValues = z.infer<typeof formSchema>;
...
export const ChatItem = ({
    ...
    const form = useForm<ChatItemValues>({
    ...
    const onSubmit = async (values: ChatItemValues) => {
        try {
                ...
                <div className="flex flex-col w-full">
                    ...
                    {isImage && (
                        <a
                            ...
                            className="relative aspect-square bg-secondary rounded-md mt-2 overflow-hidden border flex items-center h-48 w-48"
                        >
                            <Image
                                src={fileUrl}
                                alt={content}
